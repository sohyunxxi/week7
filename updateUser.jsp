...
<body>
    ...
    <main>
        <div id="signupWordBox">
            ...
            <span id="signupExplain">If you finish your update, click submit button. </span>
            
        </div>
        <form name="signupForm" action="updatingAccount.jsp" onsubmit="return inputCheck()">
            <div id="signupBox">
                <div id="signupShouldWrite">
                    <h2 class="signupTextBox"> You must write down</h2>
                    ...
                    <span name="id_value" class="inputBox"><%=email%> </span>
                </div>
                ...
                <div id="signupEtc">
                    ...
                    <input name="tel" class="inputBox"  type="text" length="20" maxlength="18">
                    <span class="spanFont">Address</span>
                    <input name="address" class="inputBox" type="text" length="20" maxlength="18">
            ...
            <input type="submit" name="updateAccount" id="signupButton" value="submit">
        </form>
        <form action="deleteAccount.jsp">
            <input type=submit class="keepButton" value="회원탈퇴"></form>
        <!-- <img src="back.png"> -->
