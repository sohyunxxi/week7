        ...
        <form name="signupForm" action="signup.jsp" onsubmit="return inputCheck()">
            <div id="signupBox">
                <div id="signupShouldWrite">
                    <h2 class="signupTextBox"> You should write down</h2>
                    ...
                    <input name="pw_value1"class="inputBox"  type="password" length="20" maxlength="18">

                    <span class="spanFont">Password Check*</span>
                    <input name="pw_value2"  class="inputBox"  type="password" length="20" maxlength="18">
